...
namespace LunarConsole
{
    ...
    public class LunarConsole : MonoBehaviour
    {
        ...
        bool InitPlatform(int capacity, int trim)
        {
            ...
            {
                Debug.LogError("Can't init " + LunarConsoleInternal.Constants.PluginName + ": " + e.Message);
            }
        ...
        IPlatform CreatePlatform(int capacity, int trim)
        {
            ...
            {
                return new PlatformAndroid(LunarConsoleInternal.Constants.Version, capacity, trim, GetGestureName(gesture));
            }
            #endif
        ...
        public static void Show()
        {
            ...
            {
                Debug.LogError("Can't show " + LunarConsoleInternal.Constants.PluginName + ": Instance is not initialized. Make sure you've installed it correctly");
            }
            #endif
        }
        ...
        public static void Hide()
        {
            ...
            {
                Debug.LogError("Can't hide " + LunarConsoleInternal.Constants.PluginName + ": Instance is not initialized. Make sure you've installed it correctly");
            }
            #endif
        }
        ...
        public static void Clear()
        {
            ...
            {
                Debug.LogError("Can't clear " + LunarConsoleInternal.Constants.PluginName + ": Instance is not initialized. Make sure you've installed it correctly");
            }
            #endif
        }
    }
    ...
    public static class Editor
    {
        ...
        static string ResolvePluginFile()
        {
            ...
            return File.Exists(LunarConsoleInternal.Constants.PluginScriptPath) ? LunarConsoleInternal.Constants.PluginScriptPath : null;
        }
